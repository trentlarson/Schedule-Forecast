...
public class TimeScheduleLoader {
  ...
  //private static final Category log4jLog = Category.getInstance("com.icentris.jira.scheduling.TimeScheduleLoader");
  private static final Logger log4jLog = Logger.getLogger("com.icentris.jira.scheduling.TimeScheduleLoader");
