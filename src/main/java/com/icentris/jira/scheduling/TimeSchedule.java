...
public class TimeSchedule {
  ...
  protected static final Category log4jLog = Category.getInstance("com.icentris.jira.scheduling.TimeSchedule");
  protected static final Category fnebLog  = Category.getInstance("com.icentris.jira.scheduling.TimeSchedule.FNEB");
  protected static final Category fdiwwLog = Category.getInstance("com.icentris.jira.scheduling.TimeSchedule.-FDIWW-");
  protected static final Category iaaLog   = Category.getInstance("com.icentris.jira.scheduling.TimeSchedule.--IAA--");
  protected static final Category wsbLog   = Category.getInstance("com.icentris.jira.scheduling.TimeSchedule.--WSB--");
